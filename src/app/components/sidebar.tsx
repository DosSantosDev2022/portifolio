...
export async function SideBar() {
  ...
  return (
      ...
      <Image className="max-w-[50%] rounded-full " src={profile.profileImage.url} alt="Matheus Battisti" width={400} height={400} quality={100} />
      <div className="flex flex-col gap-5 w-full items-start justify-center text-center p-2 mt-2">
        ...
        <Link  href="#" className="text-zinc-50 bg-zinc-900 p-2 rounded-md hover:bg-zinc-950 duration-500 transition-all">
          Ver Currículo
        </Link>
      </div>
    </aside>
